...
{
	// CivilizationHandlers.repLevelMessage
	LEGEND(), HERO(), CHAMPION(), EXALTED(), RENOWNED(), HONORED(), FRIENDLY(), NEUTRAL(), UNFRIENDLY(), HOSTILE(), HATED(), EXILED();
	...
	public static ReputationLevel fromReputation( int rep )
	{
		...
		if ( rep < 500 )
		{
			return ReputationLevel.RENOWNED;   // 249-499
		}
