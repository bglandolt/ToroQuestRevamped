...
public class QuestData
{
	...
	// if ( !player.world.isRemote ) player.world.playSound((EntityPlayer)null,
	// player.posX, player.posY, player.posZ,
	// SoundEvents.E_PARROT_IM_ZOMBIE_VILLAGER, SoundCategory.VOICE, 0.9F, 1.2F);
	// }
	// this.setChatStack("");
	// }
	// }
	...
	// public void setChatStackString(String chatStack, EntityPlayer player,
	// @Nullable String extra) CSTA
	// {
	...
	public void setChatStack( String chatStack, EntityPlayer player, @Nullable String extra )
	{
		...
		try
		{
			...
			// s =
			// I18n.format(I18n.format(chatStack+player.world.rand.nextInt(Integer.parseInt(I18n.format(chatStack)))));
		}
		catch (Exception e)
		{
	...
	// public void setChatStack(String chatStack, EntityPlayer player, @Nullable
	// String extra) CSTA
	// {
	// String s = "";
	// chatStack = "quests."+chatStack;
	...
	// try
	// {
	// s = TextComponentHelper.createComponentTranslation(player,
	// chatStack+player.world.rand.nextInt(
	// Integer.parseInt(TextComponentHelper.createComponentTranslation(player,chatStack,new
	// Object[0]).getUnformattedText()) ), new Object[0]).getFormattedText();
	// // s =
	// I18n.format(I18n.format(chatStack+player.world.rand.nextInt(Integer.parseInt(I18n.format(chatStack)))));
	// }
	// catch ( Exception e )
	// {
	// s = TextComponentHelper.createComponentTranslation(player, chatStack, new
	// Object[0]).getFormattedText();
	// }
	//
	// s = s.replace("@p", player.getDisplayNameString());
	//
