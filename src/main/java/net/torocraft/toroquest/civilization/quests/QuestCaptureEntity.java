...
//
//		x += province.getCenterPosX();
//		z += province.getCenterPosZ();
//
...
//		if ( province == null )
//		{
//			province = CivilizationUtil.getProvinceAt(player.world, x / 16 + 1, z / 16 + 1);
//		}
//		if ( province == null )
//		{
//			province = CivilizationUtil.getProvinceAt(player.world, x / 16 + 1, z / 16 - 1);
...
//	}
	...
	private boolean perform( DataWrapper quest )
	{
		...
		if ( !quest.getData().getCompleted() )
		{
			...
			// TextComponentString(MathHelper.clamp(quest.getCurrentAmount(), 0,
			// quest.getTargetAmount())+"/"+quest.getTargetAmount()), true);
