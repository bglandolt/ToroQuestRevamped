...
public class QuestEnemySpiderPit extends QuestBase implements Quest
{
	...
	private void placeDungeonRoom( World world, QuestData data, int xCenter, int zCenter )
	{
		...
		for ( int i = 0; height > i; i++ )
		{
			...
			if ( rand.nextInt(16) != 0 )
				world.setBlockState(new BlockPos(xCenter, y, zCenter), Blocks.STONEBRICK.getDefaultState());
			if ( rand.nextInt(16) != 0 )
				world.setBlockState(new BlockPos(xCenter - 1, y, zCenter), Blocks.STONEBRICK.getDefaultState());
			else
				world.setBlockState(new BlockPos(xCenter - 1, y, zCenter), Blocks.STONE_BRICK_STAIRS.getDefaultState());
			if ( rand.nextInt(16) != 0 )
				world.setBlockState(new BlockPos(xCenter, y, zCenter - 1), Blocks.STONEBRICK.getDefaultState());
			else
				world.setBlockState(new BlockPos(xCenter, y, zCenter - 1), Blocks.STONE_BRICK_STAIRS.getDefaultState());
			if ( rand.nextInt(16) != 0 )
				world.setBlockState(new BlockPos(xCenter - 1, y, zCenter - 1), Blocks.STONEBRICK.getDefaultState());
		}
	...
	public QuestData generateQuestFor( EntityPlayer player, Province province )
	{
		...
		setRewardItems(q.getData(), reward);
