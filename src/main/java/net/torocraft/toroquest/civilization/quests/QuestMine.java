...
public class QuestMine extends QuestBase implements Quest
{
	...
	////
	//// if ( questId == null || provinceId == null || provinceName == null ) // ||
	// !provinceId.equals(inProvince.id.toString()))
	//// {
	//// return;
	//// }
	//
	...
	// {
	// if ( eventBlock == Blocks.REDSTONE_ORE || itemstack.getItem() ==
	// Items.REDSTONE )
	// {
	// blockName = "Redstone";
	...
	// event.getPos().getY(), event.getPos().getZ(), itemstack.copy() );
	...
	// I18n.format("quest.quest_complete_message") ),
	// ToroQuestConfiguration.showQuestCompletionAboveActionBar );
	// }
	// player.world.playSound((EntityPlayer)null, player.posX, player.posY,
	// player.posZ, SoundEvents.ENTITY_EXPERIENCE_ORB_PICKUP, SoundCategory.PLAYERS,
	// 1.1F, 1.1F);
	// }
	// player.sendStatusMessage( new TextComponentString( q.getCurrentAmount() + "/"
	// + q.getTargetAmount() + " " + blockName ), true);
	//
	// return;
	// }
	...
	// Arrays.<NonNullList<ItemStack>>asList(player.inventory.mainInventory,
	...
	// TextComponentString(MathHelper.clamp(afterAmount, 0,
	// requiredAmount)+"/"+requiredAmount), true);
	//
	...
	public List<ItemStack> complete( QuestData data, List<ItemStack> in )
	{
		...
		// {
		// data.setChatStack( "mine.stone.incomplete", data.getPlayer(),
		// ""+requiredLeft);
		// }
		// else if ( block == Blocks.REDSTONE_ORE )
		// {
		// data.setChatStack( "mine.redstone.incomplete", data.getPlayer(),
		// ""+requiredLeft);
		// }
		// else if ( block == Blocks.COAL_ORE )
		// {
		// data.setChatStack( "mine.coal.incomplete", data.getPlayer(),
		// ""+requiredLeft);
		// }
		// else if ( block == Blocks.GRAVEL )
		// {
		// data.setChatStack( "mine.gravel.incomplete", data.getPlayer(),
		// ""+requiredLeft);
		// }
		// else if ( block == Blocks.DIRT )
		// {
		// data.setChatStack( "mine.dirt.incomplete", data.getPlayer(),
		// ""+requiredLeft);
		// }
		//
		// }
	...
	public List<ItemStack> reject( QuestData data, List<ItemStack> in )
	{
		...
		// for (ItemStack item : givenItems)
		// {
		// if (!item.isEmpty() && item.getItem() == Items.EMERALD && item.getCount() >=
		// 5)
		// {
		// int decBy = Math.min(item.getCount(), emeraldRemainingCount);
		// emeraldRemainingCount -= decBy;
	...
	public List<ItemStack> accept( QuestData data, List<ItemStack> in )
	{
		...
		// tool.setStackDisplayName(tool.getDisplayName() + " of " +
		// province.name.toString() );
		// tool.addEnchantment(Enchantment.getEnchantmentByLocation("minecraft:unbreaking"),
		// 1);
		// tool.setTagInfo("mine_quest", new
		// NBTTagString(q.getData().getQuestId().toString()));
	...
	// public static final List<ItemStack> blockStone =
	// OreDictionary.getOres("stone");

	// public static final List<ItemStack> blockStone =
	// OreDictionary.getOres("stone");

	// public static final List<ItemStack> blockStoneBrick =
	// OreDictionary.getOres("stonebrick");
