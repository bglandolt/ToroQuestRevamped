...
public class ItemLordReply extends Item
{
	public static ItemLordReply INSTANCE;
	public static final String NAME = "lord_reply";
	private static ResourceLocation REGISTRY_NAME = new ResourceLocation(ToroQuest.MODID, NAME);

	@SubscribeEvent
	public static void init( final RegistryEvent.Register<Item> event )
	{
		INSTANCE = new ItemLordReply();
	...
	{
		tooltip.add("A wrapped package presumabley containing important documents and information. §7[put this item in left column to complete the quest]§r");
	}
}
