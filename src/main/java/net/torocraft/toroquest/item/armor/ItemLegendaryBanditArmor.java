...
public class ItemLegendaryBanditArmor extends ItemArmor
{
	...
	public void addInformation( ItemStack stack, @Nullable World worldIn, List<String> tooltip, ITooltipFlag flagIn )
	{
		...
		// tooltip.add("Donate this trophy to a village lord: You gain the strength of
		// the bandit lord while in your province. OR you could look hella fresh and
		// wear it. Go ahead, put on the mask...");
	}
