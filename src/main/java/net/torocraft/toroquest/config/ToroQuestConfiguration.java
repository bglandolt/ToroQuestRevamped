...
public class ToroQuestConfiguration
{
	...
	public static boolean removeProvinceOnLordDeath = true;
	...
	public static boolean showGatedTradesAsLocked = true;
	...
	public static String lanternResourceName = "rustic:iron_lantern";
	public static String chainResourceName = "rustic:chain";
	...
	public static boolean toastReputationLevels = true;
	...
	public static boolean broadcastLordSlain = true;
	...
	public static boolean toastQuestCompletion = true;
	...
	public static int maxTradeAmount = 6;
	public static int tradeInventoryAmount = 32;
	...
	public static String[] gatedTradeList = new String[] {};
	public static ArrayList<GatedTrade> gatedTrades = new ArrayList<GatedTrade>();
	...
	private static void loadConfiguration()
	{
		try
		{
			...
			// adventurerSkins = config.getInt("adventurerSkins", CATEGORY_SKINS, 1, 1,
			// 5120,
			// "The number of adventurer skins in your Resource Folder (check mod
			// description on CurseForge for details) that you wish to use. For example, in
			// your folder you have adventurer_0,"
			// + " adventurer_1, adventurer_2, adventurer_3, adventurer_4, then you would
			...
			// enableBloodParticles = config.getBoolean("enableBloodParticles",
			// CATEGORY_MOBS, false,
			...
			// guardWatchClosestTask = config.getBoolean("guardWatchClosestTask",
			// CATEGORY_MOBS, false,
			// "Enable to add watch closest task to guards (they look at entities around
			// them randomly). Disable to slightly improve performance.");

			// guardLookIdleTask = config.getBoolean("guardLookIdleTask", CATEGORY_MOBS, false, "Enable to add look idle task to guards (they look around randomly). Disable to slightly improve performance.");
			...
			// villagesSpawnGolems = config.getBoolean("villagesSpawnGolems", CATEGORY_MOBS,
			// false,
			...
			// feralWolfResourceName = config.getString("feralWolfResourceName",
			// CATEGORY_MOBS, "its_meow.betteranimalsplus.common.entity.EntityFeralWolf",
			// "Resource string for feral wolves. These will spawn to attack villages
			// instead of normal wolves.");
			...
			// adventurerSpawnRate = config.getInt("adventurerSpawnRate", CATEGORY_SPAWNING,
			// 6, 0, 100, "every 1200 ticks/ every minute, the chance out of 100 for a
			// random player to have adventurers spawned near them."
			// + " This chance increases by 2 for each other player online, up to a max of
			// adventurersSpawnRate*2. Setting to 0 will disable spawning. NOTE: there are
			// 24000 ticks per day/night cycle. These adventurers eventually despawn.");
			...
			// toastReputationLevels = config.getBoolean("toastReputationLevels", CATEGORY,
			// true,
			// "If set to true, quests and reputation checkpoints appear as achievements.");
			...
			gatedTradeList = config.getStringList("gatedTradeList", CATEGORY_TRADES,

				new String[]
				{
					// BLACKSMITH =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
					"minecraft:diamond,1,x,minecraft:emerald,16,x,0,blacksmith,x=minecraft:emerald,16,x,minecraft:diamond,1",

					// 0 diamonds
					"minecraft:diamond,1,x,minecraft:emerald,16,x,1000,blacksmith,0=minecraft:emerald,16,x,minecraft:diamond,1",
					
					"minecraft:blaze_powder,9,x,minecraft:emerald,1,x,50,cleric,1=minecraft:emerald,1,x,minecraft:blaze_powder,9",
					"minecraft:ghast_tear,1,x,minecraft:emerald,11,x,500,cleric,1=minecraft:emerald,11,x,minecraft:ghast_tear,1",
					"minecraft:dragon_breath,1,x,minecraft:emerald,1,x,1000,cleric,1=minecraft:emerald,1,x,minecraft:dragon_breath,1",
					
					"minecraft:nether_wart,16,x,minecraft:emerald,1,x,250,cleric,4=minecraft:emerald,1,x,minecraft:nether_wart,16",
				},
			...
			tradeList = config.getStringList("tradeList", CATEGORY_TRADES,
				...
				new String[]
				{
					...
					"minecraft:emerald,1,x,minecraft:beetroot_seeds,24,x,x,farmer,0", "minecraft:beetroot_seeds,24,x,minecraft:emerald,1,x,x,farmer,0",

					"minecraft:emerald,1,x,minecraft:beetroot,20,x,x,farmer,0", "minecraft:beetroot,20,x,minecraft:emerald,1,x,x,farmer,0",

					"minecraft:emerald,1,x,minecraft:carrot,20,x,50,farmer,0", "minecraft:carrot,20,x,minecraft:emerald,1,x,50,farmer,0",

					"minecraft:emerald,1,x,minecraft:potato,20,x,100,farmer,0", "minecraft:potato,20,x,minecraft:emerald,1,x,100,farmer,0",

					// 1 wheat

					"minecraft:emerald,1,x,minecraft:wheat_seeds,24,x,x,farmer,1", "minecraft:wheat_seeds,24,x,minecraft:emerald,1,x,x,farmer,1",

					"minecraft:emerald,1,x,minecraft:wheat,16,x,x,farmer,1", "minecraft:wheat,16,x,minecraft:emerald,1,x,x,farmer,1",

					// 2 sugarcane
					"minecraft:emerald,1,x,minecraft:reeds,24,x,x,farmer,2", "minecraft:reeds,24,x,minecraft:emerald,1,x,x,farmer,2",

					// 3 melon/pumpkins
					"minecraft:emerald,1,x,minecraft:pumpkin,6,x,x,farmer,3", "minecraft:pumpkin,6,x,minecraft:emerald,1,x,x,farmer,3",

					"minecraft:emerald,1,x,minecraft:melon,24,x,100,farmer,3", "minecraft:melon,24,x,minecraft:emerald,1,x,100,farmer,3",

					// 4 apple
					"minecraft:emerald,1,x,minecraft:apple,6,x,x,farmer,4", "minecraft:apple,6,x,minecraft:emerald,1,x,x,farmer,4",

					"minecraft:sapling,12,x,minecraft:emerald,1,x,100,farmer,4", "minecraft:emerald,1,x,minecraft:sapling,12,x,100,farmer,4",
					...
					// "minecraft:emerald,16,x,minecraft:golden_sword,1,x,100,weapon,1,Sword of
					// Righteousness~minecraft:smite~5~minecraft:fire_aspect~5",
					...
					// 0 undead
					"minecraft:rotten_flesh,20,x,minecraft:emerald,1,x,x,cleric,0", "minecraft:gold_ingot,3,x,minecraft:emerald,1,x,100,cleric,0", "minecraft:bone,12,x,minecraft:emerald,1,x,50,cleric,0", "minecraft:emerald,1,x,minecraft:bone,12,x,50,cleric,0",

					"minecraft:emerald,1,x,minecraft:potion,1,x,x,cleric,0,minecraft:healing~minecraft:potion", "minecraft:emerald,1,x,minecraft:potion,1,x,x,cleric,0,minecraft:healing~minecraft:splash_potion", "minecraft:emerald,2,x,minecraft:potion,1,x,1000,cleric,0,minecraft:healing~minecraft:lingering_potion",

					// 1 nether/ end

					"minecraft:emerald,1,x,minecraft:ender_pearl,1,x,250,cleric,1",

					"minecraft:emerald,3,x,minecraft:potion,1,x,x,cleric,1,minecraft:regeneration~minecraft:potion", "minecraft:emerald,3,x,minecraft:potion,1,x,x,cleric,1,minecraft:regeneration~minecraft:splash_potion", "minecraft:emerald,4,x,minecraft:potion,1,x,1000,cleric,1,minecraft:regeneration~minecraft:lingering_potion",

					// 2 overworld

					"minecraft:emerald,1,x,minecraft:spider_eye,10,x,x,cleric,2", "minecraft:emerald,1,x,minecraft:gunpowder,8,x,50,cleric,2", "minecraft:emerald,1,x,minecraft:rabbit_foot,1,x,250,cleric,2", "minecraft:emerald,1,x,minecraft:slime_ball,2,x,500,cleric,2",

					"minecraft:emerald,3,x,minecraft:potion,1,x,x,cleric,2,minecraft:swiftness~minecraft:potion", "minecraft:emerald,3,x,minecraft:potion,1,x,x,cleric,2,minecraft:swiftness~minecraft:splash_potion", "minecraft:emerald,4,x,minecraft:potion,1,x,1000,cleric,2,minecraft:swiftness~minecraft:lingering_potion",

					// 3 flowers

					"minecraft:emerald,1,x,minecraft:yellow_flower,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:1,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:2,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:3,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:4,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:5,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:6,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:7,8,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:red_flower:8,8,x,x,cleric,3",

					"minecraft:emerald,1,x,minecraft:double_plant:1,3,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:double_plant:4,3,x,x,cleric,3", "minecraft:emerald,1,x,minecraft:double_plant:5,3,x,x,cleric,3",
					...
					"minecraft:brown_mushroom,10,x,minecraft:emerald,1,x,50,cleric,4", "minecraft:emerald,1,x,minecraft:brown_mushroom,10,x,50,cleric,4",

					"minecraft:red_mushroom,10,x,minecraft:emerald,1,x,100,cleric,4", "minecraft:emerald,1,x,minecraft:red_mushroom,10,x,100,cleric,4",

					"minecraft:emerald,1,x,minecraft:potion,1,x,x,cleric,4,minecraft:poison~minecraft:splash_potion", "minecraft:emerald,2,x,minecraft:potion,1,x,1000,cleric,4,minecraft:poison~minecraft:lingering_potion",
					...
					"minecraft:glass_bottle,48,x,minecraft:emerald,1,x,50,cleric,x", "minecraft:redstone,5,x,minecraft:emerald,1,x,250,cleric,x", "minecraft:glowstone_dust,16,x,minecraft:emerald,1,x,500,cleric,x",

					// ARMOR =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

					"minecraft:emerald,2,x,minecraft:iron_boots,1,x,x,armor,x", "minecraft:emerald,3,x,minecraft:iron_leggings,1,x,x,armor,x", "minecraft:emerald,2,x,minecraft:iron_helmet,1,x,x,armor,x", "minecraft:emerald,4,x,minecraft:iron_chestplate,1,x,x,armor,x",

					"minecraft:emerald,1,x,minecraft:chainmail_boots,1,x,100,armor,x", "minecraft:emerald,2,x,minecraft:chainmail_leggings,1,x,100,armor,x", "minecraft:emerald,1,x,minecraft:chainmail_helmet,1,x,100,armor,x", "minecraft:emerald,3,x,minecraft:chainmail_chestplate,1,x,100,armor,x",
					...
					"minecraft:emerald,1,x,minecraft:stone:1,64,x,100,tool,1", "minecraft:emerald,1,x,minecraft:stone:3,64,x,100,tool,1", "minecraft:emerald,1,x,minecraft:stone:5,64,x,100,tool,1",
					...
					"minecraft:emerald,1,x,minecraft:stonebrick,32,x,x,tool,2", "minecraft:stonebrick,32,x,minecraft:emerald,1,x,x,tool,2",

					// 3 wood
					"minecraft:iron_axe,1,x,minecraft:emerald,1,x,x,tool,3",

					"minecraft:emerald,1,x,minecraft:log,16,x,x,tool,3", "minecraft:emerald,1,x,minecraft:log:1,16,x,x,tool,3", "minecraft:emerald,1,x,minecraft:log:2,16,x,x,tool,3", "minecraft:emerald,1,x,minecraft:log:3,16,x,x,tool,3", "minecraft:emerald,1,x,minecraft:log2,16,x,x,tool,3", "minecraft:emerald,1,x,minecraft:log2:1,16,x,x,tool,3",

					// 4 sands

					"minecraft:emerald,1,x,minecraft:iron_shovel,1,x,x,tool,4",

					"minecraft:emerald,1,x,minecraft:dirt,64,x,x,tool,4", "minecraft:emerald,1,x,minecraft:sand,64,x,50,tool,4", "minecraft:emerald,1,x,minecraft:gravel,32,x,100,tool,4", "minecraft:emerald,1,x,minecraft:clay,16,x,100,tool,4", "minecraft:emerald,1,x,minecraft:red_sand,64,x,500,tool,4",

					"minecraft:dirt,64,x,minecraft:emerald,1,x,x,tool,4", "minecraft:sand,64,x,minecraft:emerald,1,x,50,tool,4", "minecraft:gravel,32,x,minecraft:emerald,1,x,100,tool,4", "minecraft:clay,16,x,minecraft:emerald,1,x,100,tool,4", "minecraft:red_sand,64,x,minecraft:emerald,1,x,500,tool,4",

					// BUTCHER =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

					"minecraft:emerald,1,x,minecraft:cooked_beef,10,x,x,butcher,x", "minecraft:emerald,1,x,minecraft:cooked_porkchop,10,x,x,butcher,x", "minecraft:emerald,1,x,minecraft:cooked_mutton,12,x,x,butcher,x", "minecraft:emerald,1,x,minecraft:cooked_chicken,14,x,x,butcher,x", "minecraft:emerald,1,x,minecraft:cooked_rabbit,16,x,x,butcher,x",

					"minecraft:beef,10,x,minecraft:emerald,1,x,x,butcher,x", "minecraft:porkchop,10,x,minecraft:emerald,1,x,x,butcher,x", "minecraft:mutton,12,x,minecraft:emerald,1,x,x,butcher,x", "minecraft:chicken,14,x,minecraft:emerald,1,x,x,butcher,x", "minecraft:rabbit,16,x,minecraft:emerald,1,x,x,butcher,x",
					...
					"minecraft:emerald,1,x,minecraft:leather_boots,1,x,x,leather,x", "minecraft:emerald,2,x,minecraft:leather_leggings,1,x,x,leather,x", "minecraft:emerald,1,x,minecraft:leather_helmet,1,x,x,leather,x", "minecraft:emerald,3,x,minecraft:leather_chestplate,1,x,x,leather,x",
					...
					"minecraft:emerald,32,x,minecraft:golden_horse_armor,1,x,500,leather,3", "minecraft:emerald,64,x,minecraft:iron_horse_armor,1,x,1000,leather,3", "minecraft:emerald,96,x,minecraft:diamond_horse_armor,1,x,2000,leather,3",

					// SHEPHERD =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=

					// 0
					"minecraft:wool,16,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool,16,x,x,shepherd,x",

					"minecraft:wool:14,16,x,minecraft:emerald,1,RED,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:14,16,RED,x,shepherd,x",

					"minecraft:wool:13,16,x,minecraft:emerald,1,GREEN,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:13,16,GREEN,x,shepherd,x",

					"minecraft:wool:9,16,x,minecraft:emerald,1,BLUE,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:9,16,BLUE,x,shepherd,x",

					"minecraft:wool:15,16,x,minecraft:emerald,1,BLACK,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:15,16,BLACK,x,shepherd,x",

					"minecraft:wool:4,16,x,minecraft:emerald,1,YELLOW,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:4,16,YELLOW,x,shepherd,x",

					"minecraft:wool:12,16,x,minecraft:emerald,1,BROWN,x,shepherd,x", "minecraft:emerald,1,x,minecraft:wool:12,16,BROWN,x,shepherd,x",

					"minecraft:emerald,1,x,minecraft:string,12,x,x,shepherd,x",

					"minecraft:wheat,16,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:shears,2,x,minecraft:emerald,1,x,x,shepherd,x",

					"minecraft:egg,16,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:emerald,1,x,minecraft:egg,16,x,x,shepherd,x",

					"minecraft:emerald,1,x,minecraft:feather,28,x,x,shepherd,x",

					"minecraft:wheat_seeds,24,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:melon_seeds,24,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:beetroot_seeds,24,x,minecraft:emerald,1,x,x,shepherd,x", "minecraft:pumpkin_seeds,24,x,minecraft:emerald,1,x,x,shepherd,x",
			...
			raiderString_RED_BRIAR = config.getStringList("raiderString_RED_BRIAR", CATEGORY_RAIDS,
				...
				new String[]
				{
					"its_meow.betteranimalsplus.common.entity.EntityFeralWolf~0~1.2~2~3~x", "its_meow.betteranimalsplus.common.entity.EntityFeralWolf~500~1.2~4~9~x",
				},
			...
			raiderString_BLACK_MOOR = config.getStringList("raiderString_MOOR_BLACK", CATEGORY_RAIDS,
				...
				new String[]
				{
					"thebetweenlands.common.entity.mobs.EntitySwampHag~0~1.0~6~10~x", "minecraft.entity.monster.EntityWitch~0~1.0~4~6~x", "thebetweenlands.common.entity.mobs.EntityPeatMummy~250~1.0~4~6~x", "thebetweenlands.common.entity.mobs.EntityStalker~500~1.0~3~5~x",
				},
			...
			banditOneHandedMeleeWeapons = config.getStringList("banditOneHandedMeleeWeapons", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:iron_sword", "minecraft:iron_axe", "spartanweaponry:caestus", "spartanweaponry:caestus_studded", "spartanweaponry:hammer_iron", "spartanweaponry:mace_iron", "spartanweaponry:saber_iron", "spartanweaponry:katana_iron", "spartanweaponry:rapier_iron", "spartanweaponry:warhammer_iron", "spartanweaponry:battleaxe_iron", "spartanweaponry:longsword_iron"
				},
			...
			banditTwoHandedMeleeWeapons = config.getStringList("banditTwoHandedMeleeWeapons", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:iron_sword", "minecraft:iron_axe", "spartanweaponry:spear_iron", "spartanweaponry:longsword_iron", "spartanweaponry:battleaxe_iron", "spartanweaponry:greatsword_iron", "spartanweaponry:glaive_iron", "spartanweaponry:halberd_iron"
				},
			...
			banditShields = config.getStringList("banditShields", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:shield", "spartanshields:shield_basic_wood", "spartanshields:shield_basic_stone", "spartanshields:shield_basic_iron", "spartanshields:shield_basic_gold", "spartanshields:shield_basic_obsidian"
				},
			...
			orcOneHandedMeleeWeapons = config.getStringList("orcOneHandedMeleeWeapons", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:stone_sword", "minecraft:stone_axe", "spartanweaponry:caestus", "spartanweaponry:caestus_studded", "spartanweaponry:club_wood", "spartanweaponry:club_studded", "spartanweaponry:hammer_stone", "spartanweaponry:mace_stone", "spartanweaponry:saber_stone", "spartanweaponry:katana_stone", "spartanweaponry:warhammer_stone", "spartanweaponry:battleaxe_stone", "spartanweaponry:longsword_stone"
				},
			...
			orcTwoHandedMeleeWeapons = config.getStringList("orcTwoHandedMeleeWeapons", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:stone_sword", "minecraft:stone_axe", "spartanweaponry:spear_stone", "spartanweaponry:longsword_stone", "spartanweaponry:battleaxe_stone", "spartanweaponry:greatsword_stone", "spartanweaponry:glaive_stone", "spartanweaponry:halberd_stone"
				},
			...
			orcRangedWeapons = config.getStringList("orcRangedWeapons", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"spartanweaponry:longbow_wood", "spartanweaponry:longbow_leather", "spartanweaponry:longbow_iron"
				},
			...
			orcShields = config.getStringList("orcShields", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"spartanshields:shield_tower_wood", "spartanshields:shield_tower_stone", "spartanshields:shield_tower_iron", "spartanshields:shield_tower_gold", "spartanshields:shield_tower_obsidian"
				},
			...
			enchantFirstBanditAndOrcMeleeWeapon = config.getStringList("enchantFirstBanditAndOrcMeleeWeapon", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:sharpness,2", "minecraft:sharpness,4", "minecraft:smite,4", "minecraft:bane_of_arthropods,4", "minecraft:knockback,4", "minecraft:looting,2", "minecraft:sweeping,3",
				},
			...
			enchantSecondBanditAndOrcMeleeWeapon = config.getStringList("enchantSecondBanditAndOrcMeleeWeapon", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:unbreaking,4", "minecraft:unbreaking,4", "minecraft:unbreaking,4", "minecraft:fire_aspect,2",
				},
			...
			enchantFirstBanditAndOrcRanged = config.getStringList("enchantFirstBanditAndOrcRanged", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:power,2", "minecraft:power,5", "minecraft:punch,5", "minecraft:flame,1", "minecraft:flame,1",
				},
			...
			enchantSecondBanditAndOrcRanged = config.getStringList("enchantSecondBanditAndOrcRanged", CATEGORY_WEAPONS,
				...
				new String[]
				{
					"minecraft:unbreaking,4", "minecraft:unbreaking,4", "minecraft:unbreaking,4", "minecraft:infinity,1",
				},
