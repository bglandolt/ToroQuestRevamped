...
public class WorldGenPlacer implements IWorldGenerator
{
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("mage_tower", x,
		// z))
		// {
		// // return;
		// }
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("bastions_lair",
		// x, z))
		// {
		// // return;
		// }
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("spider_lair", x,
		// z))
		// {
		// // return;
		// }
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("pig_portal", x,
		// z))
		// {
		// // return;
		// }
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("throne_room", x,
		// z))
		// {
		// // return;
		// }
	...
	{
		// if (!CivilizationsWorldSaveData.get(world).canGenStructure("grave_titan", x,
		// z))
		// {
		// // return;
		// }
