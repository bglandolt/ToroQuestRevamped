...
public class ThroneRoomGenerator extends WorldGenerator
{
	...
	// protected final IBlockState stoneBrickSlabs =
			...
			for ( int x = 0; x <= width; x++ )
			{
				for ( int z = 0; z <= length; z++ )
				{
					...
					else if ( isEntranceCarpet(y, x, z) )
					{
						if ( x == 15 && y == 4 )
						{
							currentBlock = Blocks.TRAPPED_CHEST.getDefaultState().withProperty(BlockChest.FACING, EnumFacing.SOUTH);
							world.setBlockState(startPos.add(x, y, z), currentBlock);
							...
							if ( tileentity instanceof TileEntityChest )
							{
								...
								if ( rand.nextBoolean() )
									((TileEntityChest) tileentity).setInventorySlotContents(world.rand.nextInt(20) + 2, new ItemStack(Items.GOLD_INGOT, 5));
								if ( rand.nextBoolean() )
									((TileEntityChest) tileentity).setInventorySlotContents(world.rand.nextInt(20) + 2, new ItemStack(Items.GOLD_INGOT, 5));
							}
							continue;
					...
					else if ( isEntrancePlatform(y, x, z) )
					{
						if ( x >= 13 && x <= 15 )
						{
							if ( y == 3 )
							{
								currentBlock = Blocks.TNT.getDefaultState();
								world.setBlockState(startPos.add(x, y, z), currentBlock);
								continue;
							}
							else if ( y == 2 )
					...
					else if ( isBackOfThrone(y, x, z) )
					{
						if ( y == 10 )
						{
							if ( x == 15 )
							{
								currentBlock = Blocks.SEA_LANTERN.getDefaultState();
								world.setBlockState(startPos.add(x, y, z), currentBlock);
							}
							else if ( x == 14 )
							{
								currentBlock = Blocks.QUARTZ_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.EAST);
								world.setBlockState(startPos.add(x, y, z), currentBlock);
							}
							else if ( x == 16 )
							{
								currentBlock = Blocks.QUARTZ_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST);
								world.setBlockState(startPos.add(x, y, z), currentBlock);
							}
						}
						else
					...
					if ( world.getBlockState(startPos.add(x, y, z)) == doubleSlab || world.getBlockState(startPos.add(x, y, z)) == Blocks.STONE_SLAB.getDefaultState() || world.getBlockState(startPos.add(x, y, z)) == blockFire )
					{
						continue;
					}
	...
	{
		return (y == 3 && (x == 13 || x == 17) && z == length - 6) || (y == 4 && (x == 13 || x == 17) && z == length - 5) || (y == 5 && (x == 13 || x == 17) && z == length - 4) || (y == 6 && (x == 13 || x == 17) && (z == length - 3 || z == length - 2)) || (y == 7 && (x == 13 || x == 17) && z == length - 1);
	}

	private boolean isThronePlatform( int y, int x, int z )
	{
		return (y == 1 && (x >= 13 && x <= 17) && z >= length - 9) || (y == 1 && (x == 12 || x == 18) && z >= length - 9 && z <= length - 6) || (y == 2 && (x >= 13 && x <= 17) && z >= length - 8) || (y == 3 && x >= 13 && x <= 17 && z >= length - 5) || (y == 3 && x >= 14 && x <= 16 && z >= length - 7) || (y == 4 && x >= 13 && x <= 17 && z >= length - 4) || (y == 5 && x >= 13 && x <= 17 && z >= length - 3) || (y == 6 && (x == 13 || x == 17) && z == length - 1);
	}
