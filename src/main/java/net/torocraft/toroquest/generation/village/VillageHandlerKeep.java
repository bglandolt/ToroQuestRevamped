	...
	public static class VillagePieceKeep extends VillagePieceBlockMap
	{
		...
		protected boolean specialBlockHandling( World world, String c, int x, int y, int z )
		{
			...
			else if ( c.equals("xl") )
			{
				...
				// TextComponentString message = new TextComponentString("" + world.isRemote + "
				// king place ");
				// {
			...
			//// }
			//
			// CivilizationType civ = CivilizationUtil.getProvinceAt(world, x*16,
			// z*16).civilization;
			//
			// switch ( civ )
			// {
		...
		// protected void setBlockState(World worldIn, IBlockState blockstateIn, int x,
		// int y, int z, StructureBoundingBox boundingboxIn)
