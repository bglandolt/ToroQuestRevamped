...
public class MonolithGenerator extends WorldGenerator
{
	...
	// } else if (x == xMin || x == xMax || z == zMax || z == zMin || y == yMax - 1
	// || y == yMin) {
	...
	private void placeMonolith( World world, Random rand, BlockPos pos )
	{
		...
		// setBlockAndNotifyAdequately(world, pos.add(-1,0,-1),
		// Blocks.OBSIDIAN.getDefaultState());
		// setBlockAndNotifyAdequately(world, pos.add(-1,0,0),
		// Blocks.OBSIDIAN.getDefaultState());
		// setBlockAndNotifyAdequately(world, pos.add(-1,0,1),
		// Blocks.OBSIDIAN.getDefaultState());
		// setBlockAndNotifyAdequately(world, pos.add(0,0,1),
		// Blocks.OBSIDIAN.getDefaultState());
		// setBlockAndNotifyAdequately(world, pos.add(0,0,-1),
		// Blocks.OBSIDIAN.getDefaultState());
		// setBlockAndNotifyAdequately(world, pos.add(1,0,-1),
