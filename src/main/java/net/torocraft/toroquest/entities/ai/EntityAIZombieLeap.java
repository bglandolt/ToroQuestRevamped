...
public class EntityAIZombieLeap extends EntityAIBase
{
	...
	public void startExecuting()
	{
		...
		if ( immuneWhileLeaping && this.leaper.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).getBaseValue() < 2.22D )
			this.leaper.getEntityAttribute(SharedMonsterAttributes.KNOCKBACK_RESISTANCE).setBaseValue(2.22D);
	}
}