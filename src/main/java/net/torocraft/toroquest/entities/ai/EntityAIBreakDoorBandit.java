...
public class EntityAIBreakDoorBandit extends EntityAIDoorInteract
{
	...
	public boolean shouldExecute()
	{
		...
		// else if
		// (!net.minecraftforge.event.ForgeEventFactory.getMobGriefingEvent(this.entity.world,
		// this.entity) ||
		// !this.entity.world.getBlockState(this.doorPosition).getBlock().canEntityDestroy(this.entity.world.getBlockState(this.doorPosition),
		// this.entity.world, this.doorPosition, this.entity) ||
		// !net.minecraftforge.event.ForgeEventFactory.onEntityDestroyBlock(this.entity,
		// this.doorPosition, this.entity.world.getBlockState(this.doorPosition)))
		// !net.minecraftforge.event.ForgeEventFactory.onEntityDestroyBlock(this.entity,
		// this.doorPosition, this.entity.world.getBlockState(this.doorPosition)))
	}
	...
	public void updateTask()
	{
		...
		if ( this.breakingTime >= 40 )
		{
			...
			if ( this.breakingTime >= 120 )
			{
				 ...
				 * this.entity.world.playEvent(2001, this.doorPosition,
