...
public class EntityBanditLord extends EntitySentry implements IRangedAttackMob, IMob
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityBanditLord.class, NAME, entityId, ToroQuest.INSTANCE, 80, 1, true, 0xffffff, 0x909090);
	}
