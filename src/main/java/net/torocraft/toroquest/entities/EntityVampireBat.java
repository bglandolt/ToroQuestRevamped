...
public class EntityVampireBat extends EntityMob implements IMob
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityVampireBat.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x2015, 0x909090);
	}
	...
	protected void initEntityAI()
	{
		...
		// targetTasks.addTask(3, new
		// EntityAINearestAttackableTarget<EntityToroNpc>(this, EntityToroNpc.class,
		// true));
		// targetTasks.addTask(4, new
		// EntityAINearestAttackableTarget<EntityVillager>(this, EntityVillager.class,
		// false));
		// targetTasks.addTask(5, new
		// EntityAINearestAttackableTarget<EntityAnimal>(this, EntityAnimal.class,
		// false));
	}
	...
	// for ( int i = 32; i > 0; i-- )
	// {
	// e.world.spawnParticle(EnumParticleTypes.DRAGON_BREATH,
	// x+rand.nextDouble()*2-1, y+rand.nextDouble(), z+rand.nextDouble()*2-1,
	// rand.nextDouble()-0.5, rand.nextDouble()-0.5, rand.nextDouble()-0.5, 0);
	// e.world.spawnParticle(EnumParticleTypes.PORTAL, x+rand.nextDouble()*2-1,
	// y+rand.nextDouble(), z+rand.nextDouble()*2-1, rand.nextDouble()-0.5,
	...
	protected BlockPos nonAttackLocation()
	{
		...
		return new BlockPos((int) nearbyBas.posX + rand.nextInt(30) - 15, (int) nearbyBas.posY + rand.nextInt(8) + 4, (int) nearbyBas.posZ + rand.nextInt(30) - 15);
	}
