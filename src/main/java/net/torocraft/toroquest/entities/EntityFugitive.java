...
public class EntityFugitive extends EntityVillager
{
	...
	// TODO
	// public static Achievement BOUNTY_HUNTER_ACHIEVEMNT = new
	// Achievement("bounty_hunter", "bounty_hunter", 0, 0, Items.DIAMOND_SWORD,
	// null)
	// .registerStat();

	public static void init( int entityId )
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityFugitive.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x000000, 0xe0d6b9);
	}
	...
	// @Override
	// public IEntityLivingData finalizeMobSpawn(DifficultyInstance p_190672_1_,
	// @Nullable IEntityLivingData p_190672_2_, boolean p_190672_3_) {
	// return p_190672_2_;
	// }
	...
	// private static final Item[] STOLEN_ITEMS = { Items.DIAMOND_AXE,
	// Items.IRON_AXE, Items.DIAMOND_PICKAXE, Items.IRON_PICKAXE,
	// Items.GOLDEN_APPLE,
	// Items.GOLD_INGOT, Items.DIAMOND, Items.BOW, Items.SHIELD, Items.BANNER,
	// Items.DIAMOND_SWORD, Items.GOLDEN_SWORD, Items.CHAINMAIL_HELMET,
	// Items.DIAMOND_BOOTS };
