...
public class EntityZombieVillagerRaider extends EntityZombieVillager implements IMob
{
	...
	public static DataParameter<Integer> DESPAWN_TIMER = EntityDataManager.<Integer>createKey(EntityZombieVillagerRaider.class, DataSerializers.VARINT);
	public static DataParameter<Integer> RAID_X = EntityDataManager.<Integer>createKey(EntityZombieVillagerRaider.class, DataSerializers.VARINT);
	public static DataParameter<Integer> RAID_Z = EntityDataManager.<Integer>createKey(EntityZombieVillagerRaider.class, DataSerializers.VARINT);
	...
	public EntityZombieVillagerRaider( World worldIn, boolean bossMob )
	{
		super(worldIn);
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityZombieVillagerRaider.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x000000, 0x000000);
	}
}