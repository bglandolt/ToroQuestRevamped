...
public class EntityZombieRaider extends EntityZombie implements IMob
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityZombieRaider.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x000000, 0xe000000);
	}
