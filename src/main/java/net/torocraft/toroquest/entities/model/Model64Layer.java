...
public class Model64Layer extends ModelBiped
{
	...
	public Model64Layer( float modelSize )
	{
		...
		// this.bipedLeftArmwear.addBox(-1.0F, -2.0F, -2.0F, 3, 12, 4, modelSize +
		// 0.3F);
		...
		// this.bipedRightArmwear.addBox(-2.0F, -2.0F, -2.0F, 3, 12, 4, modelSize +
		// 0.3F);
	...
	public void render( Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale )
	{
		...
		// {
		// float x = -2.0F + 1.5F *
		// this.triangleWave(((EntitySentry)entityIn).climbingTimer , 30.0F);
	...
	public void setRotationAngles( float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn )
	{
		...
		// if ( ((EntitySentry)entityIn).isSwingInProgress )
		// {
		// float x = -2.0F + this.triangleWave(((EntitySentry)entityIn).weaponSwing-- ,
		// 30.0F);
