...
public class ModelMonolithEye extends ModelBase
{
	...
	public ModelMonolithEye()
	{
		...
		// this.guardianBody.setTextureOffset(0, 0).addBox(-6.0F, 10.0F, -8.0F, 12, 12,
		// 16);
		// this.guardianBody.setTextureOffset(0, 28).addBox(-8.0F, 10.0F, -6.0F, 2, 12,
		// 12);
		// this.guardianBody.setTextureOffset(0, 28).addBox(6.0F, 10.0F, -6.0F, 2, 12,
		// 12, true);
		// this.guardianBody.setTextureOffset(16, 40).addBox(-6.0F, 8.0F, -6.0F, 12, 2,
		// 12);
		// this.guardianBody.setTextureOffset(16, 40).addBox(-6.0F, 22.0F, -6.0F, 12, 2,
		// 12);
		//
	...
	public void setRotationAngles( float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn )
	{
		...
		// Vec3d vec3d3 = (new Vec3d(vec3d1.x - vec3d.x, 0.0D, vec3d1.z -
		// vec3d.z)).normalize().rotateYaw(((float) Math.PI / 2F));
		// double d1 = vec3d2.dotProduct(vec3d3);
		// this.guardianEye.rotationPointX = MathHelper.sqrt((float) Math.abs(d1)) *
		// 2.0F * (float) Math.signum(d1);
		// }
