...
public class EntityWolfRaider extends EntityWolf implements IMob
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityWolfRaider.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x203090, 0xe09939);
	}
