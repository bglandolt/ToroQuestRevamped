...
public class EntityShopkeeper extends EntityToroVillager implements IMerchant
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityShopkeeper.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0x000000, 0xe0d6b9);
	}
