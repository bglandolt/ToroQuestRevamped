...
public class EntityGraveTitan extends EntityZombie implements IMob
{
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityGraveTitan.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0xffffff, 0x909090);
	}
	...
	public IEntityLivingData onInitialSpawn( DifficultyInstance difficulty, @Nullable IEntityLivingData livingdata )
	{
		...
		// * ToroQuestConfiguration.bossHealthMultiplier);
