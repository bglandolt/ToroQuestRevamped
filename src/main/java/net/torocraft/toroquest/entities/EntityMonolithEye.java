...
public class EntityMonolithEye extends EntityMob implements IRangedAttackMob, IMob
{
	...
	// }
	//
	// this.parentEntity.getLookHelper().setLookPositionWithEntity(entitylivingbase,
	// 30.0F, 30.0F);
	//
	...
	// {
	// world.playEvent((EntityPlayer)null, 1015, new BlockPos(this.parentEntity),
	// 0);
	// this.attacks = 3;
	// }
	//
	...
	// (double)(entitylivingbase.height / 4.0F) - (this.parentEntity.posY);
	// double d4 = entitylivingbase.posZ - (this.parentEntity.posZ + vec3d.z *
	// 4.0D);
	// world.playEvent((EntityPlayer)null, 1016, new BlockPos(this.parentEntity),
	// 0);
	// EntityLargeFireball entitylargefireball = new EntityLargeFireball(world,
	// this.parentEntity, d2, d3, d4);
	// entitylargefireball.explosionPower = 2;
	// entitylargefireball.posX = this.parentEntity.posX + vec3d.x * 4.0D;
	// entitylargefireball.posY = this.parentEntity.posY +
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityMonolithEye.class, NAME, entityId, ToroQuest.INSTANCE, 80, 3, true, 0xff3024, 0xe0d6b9);
	}
	...
	protected void initEntityAI()
	{
		...
		// this.tasks.addTask(3, new EntityAIWatchClosest(this, EntityPlayer.class,
		// 64.0F));
		// this.targetTasks.addTask(1, new EntityAINearestAttackableTarget(this,
		// EntityLivingBase.class, 0, true, false, new
		// MonolithEyeTargetSelector(this)));
	}
	...
	public void spawnAuraParticle()
	{
		...
		// this.rand.nextGaussian() * 16, this.posY + this.rand.nextGaussian() * 16,
		// this.posZ + this.rand.nextGaussian() * 16, this.rand.nextGaussian() * 0.05D,
		// this.rand.nextGaussian() * 0.05D, this.rand.nextGaussian() * 0.05D, new
		// int[0]);
		// this.world.spawnParticle(EnumParticleTypes.PORTAL, this.posX +
		// this.rand.nextGaussian() * 16, this.posY + this.rand.nextGaussian() * 16,
		// this.posZ + this.rand.nextGaussian() * 16, this.rand.nextGaussian() * 0.05D,
	...
	// for (int i = 0; i < 32; ++i)
	// {
	// world.spawnParticle(EnumParticleTypes.PORTAL, posX, posY, posZ, xSpeed,
	// ySpeed, zSpeed, new int[0]);
	// }
	// }
	// else
	// {
	...
	//
	// if (source.getTrueSource() != null && source.getTrueSource() instanceof
	// EntityLivingBase) {
	...
	// entityarrow.setDamage((double) (charge * 2.0F) + this.rand.nextGaussian() *
	// 0.25D
