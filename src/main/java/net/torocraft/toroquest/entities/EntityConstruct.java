...
public class EntityConstruct extends EntityGolem implements IMob
{
	...
	// EntityDataManager.<Byte>createKey(EntityConstruct.class,
	...
	{
		EntityRegistry.registerModEntity(new ResourceLocation(ToroQuest.MODID, NAME), EntityConstruct.class, NAME, entityId, ToroQuest.INSTANCE, 80, 1, true, 0x995533, 0x99aa33);
	}
	...
	public boolean isPotionApplicable( PotionEffect potioneffectIn )
	{
		if ( potioneffectIn.getPotion() == MobEffects.POISON )
		{
			...
			// event = new
			// net.minecraftforge.event.entity.living.PotionEvent.PotionApplicableEvent(this,
			// potioneffectIn);
	...
	public boolean attackEntityAsMob( Entity entityIn )
	{
		...
		// this.playSound(SoundEvents.BLOCK_DISPENSER_LAUNCH, 1.0F, 0.7F +
	...
	public boolean attackEntityFrom( DamageSource source, float amount )
	{
		...
		if ( source.getTrueSource() instanceof EntityLivingBase )
		{
			...
			if ( rand.nextBoolean() && !(e instanceof EntityConstruct) )
	...
	public void onLivingUpdate()
	{
		...
		// this.world.newExplosion(this, this.posX, this.posY, this.posZ, 3.0F, false,
		// true);
		// }
		...
		if ( this.getAttackTarget() != null && this.getAttackTarget().isEntityAlive() )
		{
			...
			if ( dist <= 200 )
			{
				...
				if ( tt == 0 || rand.nextBoolean() && tt == 12 || rand.nextBoolean() && tt % 33 == 0 )
				{
					...
					{
					case 0:
						this.playSound(SoundHandler.STEAM_0, 1.0F, 0.8F + rand.nextFloat() * 0.4F);
						break;
					case 1:
						this.playSound(SoundHandler.STEAM_1, 1.0F, 0.8F + rand.nextFloat() * 0.4F);
						break;
					case 2:
						this.playSound(SoundHandler.STEAM_2, 1.0F, 0.8F + rand.nextFloat() * 0.4F);
						break;
					case 3:
						this.playSound(SoundHandler.STEAM_3, 1.0F, 0.8F + rand.nextFloat() * 0.4F);
						break;
					}
					// this.playSound(SoundEvents.ENTITY_TNT_PRIMED, 1.5F, 1.5F +
					// rand.nextFloat()/10.0F);
	...
	{
		if ( rand.nextBoolean() )
			this.playSound(SoundHandler.STEAM_STEP_0, 0.8F, 0.8F + rand.nextFloat() * 0.4F);
		else
			this.playSound(SoundHandler.STEAM_STEP_1, 0.8F, 0.8F + rand.nextFloat() * 0.4F);
