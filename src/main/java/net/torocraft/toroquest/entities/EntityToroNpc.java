...
public class EntityToroNpc extends EntityCreature
{
	...
	// {
	// return ( this.getDataManager().get(RAID_X) == 0 &&
	// this.getDataManager().get(RAID_Y) == 0 && this.getDataManager().get(RAID_Z)
	// == 0 );
	// }
	...
	// ============================ PROVINCE =============================
	// public static DataParameter<String> PROV =
	// EntityDataManager.<String>createKey(EntityToroNpc.class,
