...
public class EntityAIFlee extends EntityAIBase
{
	...
	public void startExecuting()
	{
		...
		// this.creature.getLookHelper().setLookPosition(this.creature.posX,
		// this.creature.posY + (double)this.creature.getEyeHeight(),
		// this.creature.posZ, (float)this.creature.getHorizontalFaceSpeed(),
	...
	public boolean shouldContinueExecuting()
	{
		...
		// if ( this.creature.getNavigator().tryMoveToXYZ(this.randPosX, this.randPosY,
		...
		if ( --this.runningTimer < 1 && this.creature.limitPotions > 0 ) // If the bandit has ran far enough and has a
																		 // potion
		{
